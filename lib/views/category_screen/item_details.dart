                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        Row(
                          children: [
                            SizedBox(width: 100, child: "Color: ".text.make()),
                            Row(
                        ...
                        Row(
                          children: [
                            SizedBox(width: 100, child: "Total: ".text.make()),
                            "\$0.00".text
                                .color(redColor)
                                .size(16)
                                .fontFamily(bold)
                    ...
                    "Description".text
                        ...
                        .make(),
                    10.heightBox,
                    "This is dummy item and dummy description here ...".text
                        .color(darkFontGrey)
                        .make(),
                    ...
                    ListView(
                      ...
                      children: List.generate(
                        ...
                        (index) => ListTile(
                          title: itemsDetailsButtonList[index].text
                              .fontFamily(semibold)
                              .color(darkFontGrey)
                              .make(),
